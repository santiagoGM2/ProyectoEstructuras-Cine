...
const Cartelera = () => {
  ...
  const numeroDePeliculas = 12; // Número de películas que deseas mostrar
  const pageSize = 200; // Tamaño de página de la API de TMDB
  ...
  return (
    <>
      <br />
      <h1 className='carteleraTitulo'>Cartelera Actual</h1>
